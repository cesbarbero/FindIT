...
def conectar_bd():
    try:
        conn = pyodbc.connect(
            ...
            r'SERVER=sistemas01\SQLEXPRESS;'
            r'DATABASE=InvenIT;'
...
def buscar_datos():
    ...
    conn = conectar_bd()
    if conn is None:  # Verificamos si la conexión fue exitosa
        return
    ...
    try:
        ...
        messagebox.showerror("Error de consulta", f"Ocurrió un error al ejecutar la consulta.\nDetalles: {e}")
    finally:
        conn.close()
