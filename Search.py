...
root.title("FABEN S.A.")
root.geometry("900x500")

# Encabezado
header = ttk.Label(root, text="Sistema de rastreo de activos informáticos", font=("Helvetica", 18, "bold"), bootstyle="primary")
header.pack(pady=20)
...
tabla = ttk.Treeview(tabla_frame, columns=("Puesto de Trabajo", "Nombre de Usuario", "Nombre de PC", "Código de PC", "Código de Monitor"), show="headings", height=10, bootstyle="light")
tabla.heading("Puesto de Trabajo", text="Puesto de Trabajo")
tabla.heading("Nombre de Usuario", text="Nombre de Usuario")
tabla.heading("Nombre de PC", text="Nombre de PC")
tabla.heading("Código de PC", text="Código de PC")
tabla.heading("Código de Monitor", text="Código de Monitor")
